...
let employee1 = new Employee("Eva", "White", new Date("1991-08-17"), "New York", "President");
let employee1 = new Employee("Man", "Super", new Date("1992-07-15"), "New York", "Protector");
let employee1 = new Employee("Woman", "Wonder", new Date("1993-06-13"), "New York", "Timer");
let employee1 = new Employee("Flash", "The", new Date("1994-05-11"), "New York", "Shipper");
