...
employeeList.push(new Employee("Eva", "White", new Date("1991-08-17"), "New York", "Leader"));
employeeList.push(new Employee("Man", "Super", new Date("1992-07-15"), "New York", "Leader"));
employeeList.push(new Employee("Woman", "Wonder", new Date("1993-06-13"), "New York", "Leader"));
employeeList.push(new Employee("Flash", "The", new Date("1994-05-19"), "New York", "Leader"));
