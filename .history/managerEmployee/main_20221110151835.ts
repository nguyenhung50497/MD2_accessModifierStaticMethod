...
employeeList.push(new Employee("Eva", "White", new Date("1991-09-19"), "New York", "Leader"));
employeeList.push(new Employee("Man", "Super", new Date("1992-09-19"), "New York", "Leader"));
