...
employeeList.push(new Employee("Eva", "White", new Date("1990-09-19"), "New York", "Leader"));
employeeList.push(new Employee("Man", "Super", new Date("1990-09-19"), "New York", "Leader"));
employeeList.push(new Employee("Woman", "Wonder", new Date("1990-09-19"), "New York", "Leader"));
employeeList.push(new Employee("Flash", "Black", new Date("1990-09-19"), "New York", "Leader"));
