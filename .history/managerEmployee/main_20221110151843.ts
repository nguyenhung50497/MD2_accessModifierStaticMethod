...
employeeList.push(new Employee("Eva", "White", new Date("1991-08-19"), "New York", "Leader"));
employeeList.push(new Employee("Man", "Super", new Date("1992-07-19"), "New York", "Leader"));
employeeList.push(new Employee("Woman", "Wonder", new Date("1993-06-19"), "New York", "Leader"));
employeeList.push(new Employee("Flash", "The", new Date("1994-09-19"), "New York", "Leader"));
